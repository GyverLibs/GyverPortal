...
# GyverPortal v3
> Релиз v3 пока не вышел, но вы можете скачать репозиторий и присоединиться к тестированию. Для esp32 нужна SDK v2+

> Есть изменения в логике работы и частичная несовместимость. Документация со списком функций и методов - актуальная, остальная документация слегка устарела и переписывается в виде [Wiki](https://github.com/GyverLibs/GyverPortal/wiki). Руководствуйтесь примерами.
