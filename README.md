...
> Есть изменения в логике работы и частичная несовместимость. Список функций и методов ниже - актуальный, остальная документация ниже слегка устарела. Полная документация к v3 находится в разработке и доступна на [Wiki репозитория](https://github.com/GyverLibs/GyverPortal/wiki). Также руководствуйтесь примерами.
