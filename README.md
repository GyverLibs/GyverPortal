...
|🔥🔥🔥<br>**Проект устарел и заброшен, не рекомендуется к использованию. Обратите внимание на новую библиотеку [Settings](https://github.com/GyverLibs/Settings) - она гораздо удобнее и эффективнее**<br>🔥🔥🔥|
| --- |
