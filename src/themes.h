...
"select {width:50%;}\n"
".switch{margin:5px 0;position:relative;display:inline-block;width:60px;height:34px}\n"
...
".block {border-radius:10px;background-color:#f2f2f2;padding:20px 0px;margin:10px 0;width: 90%;}\n"
"input[type=\"text\"],input[type=\"password\"],input[type=\"date\"],input[type=\"time\"],input[type=\"range\"],input[type=\"color\"],input[type=\"checkbox\"],select\n"
"{padding:0 8px;vertical-align:middle;position:relative;margin:2px 0 7px 0;font-size:20px;height:35px;cursor:pointer;}\n"
"input[type=\"range\"] {width:50%;height:20px;}\n"
"input[type=\"color\"] {width:100px;height:40px;}\n"
"input[type=\"checkbox\"] {width:30px;height:30px;margin-bottom:10px;}\n"
...
"input[type=\"text\"],input[type=\"password\"],input[type=\"date\"],input[type=\"time\"],input[type=\"range\"],input[type=\"color\"],input[type=\"checkbox\"],select\n"
"{padding:0 8px;color:#bbb;border:none;background-color:#2A2D35;vertical-align:middle;position:relative;margin:2px 0 7px 0;font-size:20px;height:35px;cursor:pointer;}\n"
"input[type=\"range\"] {width:50%;height:20px;}\n"
"input[type=\"color\"] {width:100px;height:40px;}\n"
"input[type=\"checkbox\"] {width:30px;height:30px;margin-bottom:10px;}\n"
